...
kubectl set image deployments/client-deployment client=sythnlkn/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=sythnlkn/multi-worker:$SHA